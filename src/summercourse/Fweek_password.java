 ...
 * @author sheha
 */
public class Fweek_password extends javax.swing.JFrame {

    /**
     * Creates new form Fweek_password
     */
    public Fweek_password() {
        initComponents();
    }
    ...
    private void iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconMouseClicked
        String a = p.getText();
        if(a.equals("fwa")){
            new summercourse.Fweek.Fweek().setVisible(true);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Fweek_password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
