 ...
 * @author sheha
 */
public class Week2_password extends javax.swing.JFrame {

    /**
     * Creates new form Week2_password
     */
    public Week2_password() {
        initComponents();
    ...
    private void iconMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_iconMouseClicked
        String a = p.getText();
        if(a.equals("w2f2")){
            new summercourse.Week2.Week_2().setVisible(true);
            dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Week2_password.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
