...
public class FweekExampage7 extends javax.swing.JFrame {

    /**
     * Creates new form FweekExampage7
     */
    public FweekExampage7() {
        initComponents();
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                ResultSet     rs  = s.executeQuery("Select Q13 , Q14 from fweek_questions where id="+n+"");
                while(rs.next()){
                ...
                }else if (Q14.equals("or")){
                        s14.setSelected(true);
                        f14.setSelected(false);
                        th14.setSelected(false);
                }else if (Q14.equals("xor")){
    ...
    private void initComponents() {
        ...
        jPanel2.add(s14);
        s14.setBounds(20, 280, 90, 23);

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 17)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(39, 50, 56));
        jLabel6.setText("14-Which Boolean operator returns True if both operands are True?");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(10, 200, 620, 21);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                if(f13.isSelected()){
                    bw13.write("index()");
                    boolean     x  = s.execute("update fweek_questions set Q13='index()' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(s13.isSelected()){
                    bw13.write("find()");
                    boolean     x2  = s.execute("update fweek_questions set Q13='find()' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(th13.isSelected()){
                    bw13.write("search()");
                    boolean     x3  = s.execute("update fweek_questions set Q13='search()' where id="+n+"");
                    boolean       done = s.execute("commit");
                }
                bw13.close();
                fw13.close();
                if(f14.isSelected()){
                    bw14.write("and");
                    boolean     x  = s.execute("update fweek_questions set Q14='and' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(s14.isSelected()){
                    bw14.write("or");
                    boolean     x2  = s.execute("update fweek_questions set Q14='or' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(th14.isSelected()){
                    bw14.write("xor");
                    boolean     x3  = s.execute("update fweek_questions set Q14='xor' where id="+n+"");
                    boolean       done = s.execute("commit");
                }
                bw14.close();
                fw14.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FweekExampage7.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
