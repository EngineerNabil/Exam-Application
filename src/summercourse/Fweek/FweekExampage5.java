...
public class FweekExampage5 extends javax.swing.JFrame {

    /**
     * Creates new form FweekExampage5
     */
    public FweekExampage5() {
        initComponents();
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                ResultSet     rs  = s.executeQuery("Select Q9 , Q10 from fweek_questions where id="+n+"");
                while(rs.next()){
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel2);
        jLabel2.setBounds(19, 62, 410, 21);
        ...
        jLabel3.setText("10-Which operator is used for set union?");
        jPanel2.add(jLabel3);
        ...
        jLabel6.setText("print(len(dictionary))");
        jPanel2.add(jLabel6);
        jLabel6.setBounds(400, 80, 240, 30);

        jLabel8.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(39, 50, 56));
        jLabel8.setText("dictionary = {\"apple\": 1, \"banana\": 2, \"cherry\": 3}");
        jPanel2.add(jLabel8);
        jLabel8.setBounds(400, 40, 360, 30);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                System.out.println(n);
                if(f9.isSelected()){
                    boolean     x  = s.execute("update fweek_questions set Q9='3' where id="+n+"");
                    bw9.write("3");
                }else if(s9.isSelected()){
                    boolean     x2  = s.execute("update fweek_questions set Q9='6' where id="+n+"");
                    bw9.write("6");
                }else if(th9.isSelected()){
                    boolean     x3  = s.execute("update fweek_questions set Q9='2' where id="+n+"");
                    bw9.write("2");
                }
                bw9.close();
                fw9.close();
                if(f10.isSelected()){
                    boolean     x  = s.execute("update fweek_questions set Q10='|' where id="+n+"");
                    bw10.write("|");
                }else if(s10.isSelected()){
                    boolean     x2  = s.execute("update fweek_questions set Q10='^' where id="+n+"");
                    bw10.write("^");
                }else if(th10.isSelected()){
                    boolean     x3  = s.execute("update fweek_questions set Q10='*' where id="+n+"");
                    bw10.write("*");
                }
                bw10.close();
                fw10.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FweekExampage5.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
