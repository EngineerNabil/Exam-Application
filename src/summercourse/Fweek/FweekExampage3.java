...
public class FweekExampage3 extends javax.swing.JFrame {

    /**
     * Creates new form FweekExampage3
     */
    public FweekExampage3() {
        initComponents();
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                ResultSet     rs  = s.executeQuery("Select Q5 , Q6 from fweek_questions where id="+n+"");
                while(rs.next()){
                    String Q5= rs.getString("Q5");
                    String Q6= rs.getString("Q6");
                if(Q5.equals("reverse()")){
                        f5.setSelected(true);
                        s5.setSelected(false);
                        th5.setSelected(false);
                }else if (Q5.equals("right()")){
                        s5.setSelected(true);
                        f5.setSelected(false);
                        th5.setSelected(false);
                }else if (Q5.equals("No Answer")){
                        th5.setSelected(true);
                        f5.setSelected(false);
                        s5.setSelected(false);
                }
                    if(Q6.equals("int() , str() , float() , complex()")){
                        f6.setSelected(true);
                        s6.setSelected(false);
                        th6.setSelected(false);
                }else if (Q6.equals("int() , str() , float()")){
                        s6.setSelected(true);
                        f6.setSelected(false);
                        th6.setSelected(false);
                }else if (Q6.equals("No Answer")){
    ...
    private void initComponents() {
        ...
        jLabel2.setText("5-What function i can use it To do this ?   \"Hello\" ------> \"olleH\"");
        jPanel1.add(jLabel2);
        ...
        jLabel3.setText("6-The different types of casting in Python are ?");
        jPanel2.add(jLabel3);
        ...
        f6.setText("int() , str() , float() , complex()");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                if(f5.isSelected()){
                    bw5.write("reverse()");
                    boolean     x  = s.execute("update fweek_questions set Q5='reverse()' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(s5.isSelected()){
                    bw5.write("right()");
                    boolean     x2  = s.execute("update fweek_questions set Q5='right()' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(th5.isSelected()){
                    bw5.write("No Answer");
                    boolean     x3  = s.execute("update fweek_questions set Q5='No Answer' where id="+n+"");
                    boolean       done = s.execute("commit");
                }
                bw5.close();
                fw5.close();
                if(f6.isSelected()){
                    bw6.write("int() , str() , float() , complex()");
                    boolean     x  = s.execute("update fweek_questions set Q6='int() , str() , float() , complex()' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(s6.isSelected()){
                    bw6.write("int() , str() , float()");
                    boolean     x2  = s.execute("update fweek_questions set Q6='int() , str() , float()' where id="+n+"");
                    boolean       done = s.execute("commit");
                }else if(th6.isSelected()){
                    bw6.write("No Answer");
                    boolean     x3  = s.execute("update fweek_questions set Q6='No Answer' where id="+n+"");
                    boolean       done = s.execute("commit");
                }
                bw6.close();
                fw6.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FweekExampage3.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
