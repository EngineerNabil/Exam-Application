...
public class Week1Exampage17 extends javax.swing.JFrame {

    /**
     * Creates new form Week1Exampage17
     */
    public Week1Exampage17() {
        initComponents();
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                ResultSet     rs  = s.executeQuery("Select Q24 from Week1_Questions where id="+n+"");
                while(rs.next()){
    ...
    private void initComponents() {
        ...
        jLabel3.setText("24-Make A variable that contain Multiline Strings ");
        jPanel2.add(jLabel3);
        ...
        a24.setBackground(new java.awt.Color(250, 250, 250));
        a24.setColumns(20);
        a24.setFont(new java.awt.Font("Calibri Light", 1, 18)); // NOI18N
        a24.setForeground(new java.awt.Color(39, 50, 56));
        a24.setRows(5);
        a24.setText("                                   write the code here ");
        a24.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(39, 50, 56), new java.awt.Color(39, 50, 56)));
        a24.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                a24MouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(a24);
    ...
    private void jLabel2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel2MouseClicked
        ...
        try {
            ...
            FileReader     fr = new javaMail().fileReader(file);
            BufferedReader br = new javaMail().bufferedReader(fr);
            String          t = "'"+a24.getText()+"'";
            int number;
            while ((number = fr.read()) != -1) {
                char n=(char)number;
                System.out.println(n);
                boolean     x  = s.execute("update WEEK1_QUESTIONS set Q24="+t+"where id="+n+"");
                boolean       done = s.execute("commit");
            }
            new Week1Exampage16().setVisible(true);
            dispose();
    ...
    private void a24MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_a24MouseClicked
        if(a24.getText().equals("                                   write the code here ")){
            a24.setText("");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Week1Exampage17.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
