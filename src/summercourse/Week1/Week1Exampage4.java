 ...
 * @author sheha
 */
public class Week1Exampage4 extends javax.swing.JFrame {

    /**
     * Creates new form Week1Exampage4
     */
    public Week1Exampage4() {
        initComponents();
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                ResultSet     rs  = s.executeQuery("Select Q7 , Q8 from Week1_Questions where id="+n+"");
                while(rs.next()){
                ...
                }else if (Q7.equals("float")){
                        f7.setSelected(false);
                        s7.setSelected(true);
                        th7.setSelected(false);
                }else if (Q7.equals("str")){
                        f7.setSelected(false);
                        s7.setSelected(false);
                ...
                }else if (Q8.equals("float")){
                        f8.setSelected(false);
                        s8.setSelected(true);
                        th8.setSelected(false);
                }else if (Q8.equals("str")){
                        f8.setSelected(false);
                        s8.setSelected(false);
    ...
    private void initComponents() {
        ...
        jLabel2.setText("7-What is the result of the expression type(\"Hello\")?");
        jPanel1.add(jLabel2);
        ...
        jPanel2.add(th8);
        th8.setBounds(20, 320, 51, 23);

        jLabel3.setFont(new java.awt.Font("Tahoma", 1, 17)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(39, 50, 56));
        jLabel3.setText("8-Which data type is used to represent a sequence of characters in Python?");
        jPanel2.add(jLabel3);
        jLabel3.setBounds(10, 190, 700, 21);
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                System.out.println(n);
            if(f7.isSelected()){
               boolean     x  = s.execute("update WEEK1_QUESTIONS set Q7='int' where id="+n+"");
               boolean       done = s.execute("commit");
            }else if(s7.isSelected()){
               boolean     x2  = s.execute("update WEEK1_QUESTIONS set Q7='float' where id="+n+"");
               boolean       done = s.execute("commit");
            }else if(th7.isSelected()){
               boolean     x3  = s.execute("update WEEK1_QUESTIONS set Q7='str' where id="+n+"");
               boolean       done = s.execute("commit");
            }
            
            if(f8.isSelected()){
               boolean     x  = s.execute("update WEEK1_QUESTIONS set Q8='int' where id="+n+"");
               boolean       done = s.execute("commit");
            }else if(s8.isSelected()){
               boolean     x2  = s.execute("update WEEK1_QUESTIONS set Q8='float' where id="+n+"");
               boolean       done = s.execute("commit");
            }else if(th8.isSelected()){
               boolean     x3  = s.execute("update WEEK1_QUESTIONS set Q8='str' where id="+n+"");
               boolean       done = s.execute("commit");
            }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Week1Exampage4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
