...
public class Week2Exampage4 extends javax.swing.JFrame {

    /**
     * Creates new form Week2Exampage4
     */
    public Week2Exampage4() {
        initComponents();
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                ResultSet     rs  = s.executeQuery("Select Q7 , Q8 from Week2_Questions where id="+n+"");
                while(rs.next()){
                    ...
                    if(Q8.equals("The program will crash")){
                        f8.setSelected(true);
                        s8.setSelected(false);
                        th8.setSelected(false);
                }else if (Q8.equals("The program will raise an unhandled exception and stop execution")){
                        s8.setSelected(true);
    ...
    private void initComponents() {
        ...
        jLabel3.setText("8-What happen if exception is raised inside the try block but is not handled by any except block?");
        jPanel2.add(jLabel3);
        ...
        f8.setText("The program will crash");
        ...
        s8.setText("The program will raise an unhandled exception and stop execution");
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        ...
        try {
            ...
            while ((number = fr.read()) != -1) {
                ...
                System.out.println(n);
                if(f7.isSelected()){
                    boolean     x  = s.execute("update WEEK2_QUESTIONS set Q7='list' where id="+n+"");
                    bw7.write("list");
                }else if(s7.isSelected()){
                    boolean     x2  = s.execute("update WEEK2_QUESTIONS set Q7='array' where id="+n+"");
                    bw7.write("array");
                }else if(th7.isSelected()){
                    boolean     x3  = s.execute("update WEEK2_QUESTIONS set Q7='tuple' where id="+n+"");
                    bw7.write("tuple");
                }
                bw7.close();
                fw7.close();
                if(f8.isSelected()){
                    boolean     x  = s.execute("update WEEK2_QUESTIONS set Q8='The program will crash' where id="+n+"");
                    bw8.write("The program will crash");
                }else if(s8.isSelected()){
                    boolean     x2  = s.execute("update WEEK2_QUESTIONS set Q8='The program will raise an unhandled exception and stop execution' where id="+n+"");
                    bw8.write("The program will raise an unhandled exception and stop execution");
                }else if(th8.isSelected()){
                    boolean     x3  = s.execute("update WEEK2_QUESTIONS set Q8='Error' where id="+n+"");
                    bw8.write("Error");
                }
                bw8.close();
                fw8.close();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Week2Exampage4.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
